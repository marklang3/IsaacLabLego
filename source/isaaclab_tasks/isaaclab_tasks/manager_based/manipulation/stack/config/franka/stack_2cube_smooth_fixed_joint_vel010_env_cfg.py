...
class EventCfg:
    ...
    # HYPERPARAMETER VARIANT: Relaxed velocity requirement
    apply_snap = EventTerm(
        ...
        params={
            ...
            "velocity_threshold": 0.10,  # RELAXED: 10cm/s (vs baseline 5cm/s)
            "use_curriculum": True,
        },
    )
...
@configclass
class Franka2CubeStackSmoothFixedJointVel010EnvCfg(Franka2CubeStackLegoJointPosRLEnvCfg):
    """2-Cube stacking with velocity_threshold=0.10 (relaxed)."""
...
@configclass
class Franka2CubeStackSmoothFixedJointVel010EnvCfg_PLAY(Franka2CubeStackSmoothFixedJointVel010EnvCfg):
    def __post_init__(self):
        super().__post_init__()
