...
class EventCfg:
    ...
    # HYPERPARAMETER VARIANT: Very relaxed velocity requirement
    apply_snap = EventTerm(
        ...
        params={
            ...
            "velocity_threshold": 0.20,  # VERY RELAXED: 20cm/s (vs baseline 5cm/s)
            "use_curriculum": True,
        },
    )
...
@configclass
class Franka2CubeStackSmoothFixedJointVel020EnvCfg(Franka2CubeStackLegoJointPosRLEnvCfg):
    """2-Cube stacking with velocity_threshold=0.20 (very relaxed)."""
...
@configclass
class Franka2CubeStackSmoothFixedJointVel020EnvCfg_PLAY(Franka2CubeStackSmoothFixedJointVel020EnvCfg):
    def __post_init__(self):
        super().__post_init__()
